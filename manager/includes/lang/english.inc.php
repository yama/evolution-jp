...
$_lang["don't know the user!" ] = "Incorrect username or password entered!";// should be same message
$_lang["wrong password!"] = "Incorrect username or password entered!";// should be same message
